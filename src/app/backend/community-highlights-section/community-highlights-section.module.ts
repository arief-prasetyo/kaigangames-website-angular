...
import { CommunityHighlightsSectionRoutingModule } from './community-highlights-section-routing.module';
...
@NgModule({
  declarations: [
    CommunityHighlightsSectionComponent
  ],
  imports: [
    CommonModule,
    CommunityHighlightsSectionRoutingModule,
    BackendFooterModule,
    BackendHeaderModule,
...
export class CommunityHighlightsSectionModule { }
