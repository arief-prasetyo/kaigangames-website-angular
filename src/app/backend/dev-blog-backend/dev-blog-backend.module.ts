...
import { DevBlogBackendRoutingModule } from './dev-blog-backend-routing.module';
...
@NgModule({
  declarations: [
    DevBlogBackendComponent
  ],
  imports: [
    CommonModule,
    DevBlogBackendRoutingModule,
    BackendFooterModule,
    BackendHeaderModule,
...
export class DevBlogBackendModule { }
