...
import { CareerFeaturedJobsRoutingModule } from './career-featured-jobs-routing.module';
...
@NgModule({
  declarations: [
    CareerFeaturedJobsComponent
  ],
  imports: [
    CommonModule,
    CareerFeaturedJobsRoutingModule,
    BackendFooterModule,
    BackendHeaderModule,
...
export class CareerFeaturedJobsModule { }
