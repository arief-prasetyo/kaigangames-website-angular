...
import { ApplicantListDatetimeRoutingModule } from './applicant-list-datetime-routing.module';
...
@NgModule({
  declarations: [
    ApplicantListDatetimeComponent
  ],
  imports: [
    CommonModule,
    OwlDateTimeModule,
    OwlNativeDateTimeModule,
    ApplicantListDatetimeRoutingModule,
    BackendFooterModule,
    BackendHeaderModule,
...
export class ApplicantListDatetimeModule { }
