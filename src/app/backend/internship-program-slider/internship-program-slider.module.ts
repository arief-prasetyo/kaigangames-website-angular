...
import { InternshipProgramSliderRoutingModule } from './internship-program-slider-routing.module';
...
@NgModule({
  declarations: [
    InternshipProgramSliderComponent
  ],
  imports: [
    CommonModule,
    InternshipProgramSliderRoutingModule,
    BackendFooterModule,
    BackendHeaderModule,
...
export class InternshipProgramSliderModule { }
