...
import { CareerBenefitPerksRoutingModule } from './career-benefit-perks-routing.module';
...
@NgModule({
  declarations: [
    CareerBenefitPerksComponent
  ],
  imports: [
    CommonModule,
    CareerBenefitPerksRoutingModule,
    BackendFooterModule,
    BackendHeaderModule,
...
export class CareerBenefitPerksModule { }
